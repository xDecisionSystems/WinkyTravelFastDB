...
FastAPI + MongoDB backend for Winky Travel.

## What this service does

- Persists app users in MongoDB.
...
Rate-limit events are stored in MongoDB `rate_limit_events` and include allowed and blocked attempts.
